...
class Inventory:
    def __init__(self, capacity):
        self.capacity = capacity  # Determines size of inventory
        self.items = []  # Holds actual item entities
    ...
    def use(self, item_entity, **kwargs):
        ...
        if item_component.use_function is None:
            ...
            if item_component.targeting and not (kwargs.get('target_x' or 'target_y')):
